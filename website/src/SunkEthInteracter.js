...
//const hardCodedBurnAddress = toUnspendableAddress(hardCodedSecret)
//const hardCodedAmount = ethers.parseEther('0.0069')
...
export class SunkEthInteracter {
    ...
    */
    ...
    async unShieldTokens(SECRET_KEY, BLOCK_NUMBER, snarkProof=undefined) {
        ...
        console.log(processedStateProof)
